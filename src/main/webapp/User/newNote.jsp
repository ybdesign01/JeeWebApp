...
<div class="card mx-5 my-5">
    ...
    <div class="card-body">
        <form action="${pageContext.request.contextPath}/addNote" method="post" id="form">
            <input type="text" class="form-control" id="email" name="email" value="${sessionScope.user.getEmail()}" placeholder="email" hidden="hidden">
            <div class="mb-3">
            ...
            <div class="mb-3">
                <div class="form-floating">
                    <textarea class="form-control" placeholder="Write something here" id="content" name="content" style="height: 200px" required></textarea>
